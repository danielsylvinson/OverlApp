...
Windows users can directly download pre-built binaries from [here](https://sourceforge.net/projects/overlapp/files/latest/download) (Built on 64-bit Win10). After downloading the zipped folder, unzip it and launch the application by double-clicking the OverlApp.exe file.
